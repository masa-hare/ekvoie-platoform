...
const translations = {
  en: {
    ...
    // Home page
    "home.title": "Making Voices Visible",
    "home.tagline": "Student concerns and the university's current explanations, side by side.",
    "home.description": `A place where ${siteConfig.memberTerm.en} can see what students are experiencing and the university's current thinking and circumstances on the same screen. Agree and Disagree are neutral signals of how other students feel; they never rank opinions.`,
    "home.viewOpinions": "See by Category",
    ...
    "howItWorks.step2Subtitle": "React with Agree / Disagree",
    "howItWorks.step2Desc": "Posts are published immediately after passing an automatic content filter. Other students can react with Agree or Disagree — neutral signals that never rank opinions or pick a winner.",
    "howItWorks.step3Title": "03 / CONTRAST",
    "howItWorks.step3Subtitle": "See It Alongside the University's View",
    "howItWorks.step3Desc": "In the category view, manually grouped student concerns are shown beside the university's current explanation for the same theme. The site does not interpret what the comparison means; that is left to you.",
  ...
  ja: {
    ...
    // Home page
    "home.title": "声を、見える形に。",
    "home.tagline": "学生が感じている課題と、大学側の考えや事情を、同じ画面に。",
    "home.description": `${siteConfig.memberTerm.ja}が感じている課題と、それに対する大学側の考えや事情を、同じ画面に並べて見られる場です。「賛成・反対」は他の学生がどう感じているかを示す目印で、意見の順位づけには使いません。`,
    "home.viewOpinions": "カテゴリーから見る",
    ...
    "howItWorks.step2Title": "02 / VOTE",
    "howItWorks.step2Subtitle": "賛成・反対で反応する",
    "howItWorks.step2Desc": "投稿は自動フィルターを通過すると即時公開されます。他の学生は「賛成・反対」で反応できます。数は意見の順位づけや表示順には使いません。",
    "howItWorks.step3Title": "03 / CONTRAST",
    "howItWorks.step3Subtitle": "大学の見解と並べて見る",
    "howItWorks.step3Desc": "カテゴリー別（対照）表示では、運営が手作業でまとめた学生の課題感と、同じテーマに対する大学側の見解・説明が並びます。この対照が何を意味するかの解釈は行いません。読む人に委ねられています。",
    "howItWorks.step4Title": "04 / TRANSPARENCY",
